...
try {
    ...
    file_put_contents($dir.'/google-private.json',json_encode(['type'=>'service_account','client_email'=>'test@example.test','private_key'=>$pem])); chmod($dir.'/google-private.json',0600);
