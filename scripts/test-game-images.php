...
try {
    ...
    foreach (['/api/slot-list.php','/api/game.php'] as $endpoint) {
        $runner='$_SERVER["REQUEST_METHOD"]="GET"; $_GET=["slug"=>"image-game"]; require '.var_export(dirname(__DIR__).$endpoint,true).';';
    ...
    gi_check($result['imported']===100,'100-game hard cap across oversized input');
