...
try {
    if ($method === 'GET') {
        echo json_encode(['ok'=>true,'settings'=>seo_settings()],JSON_UNESCAPED_SLASHES); exit;
    }
    ...
    csrf_rotate();
    echo json_encode(['ok'=>true,'settings'=>$settings,'csrfToken'=>csrf_token()],JSON_UNESCAPED_SLASHES);
